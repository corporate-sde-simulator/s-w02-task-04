...
> **Welcome to Service-Track Week 2, Task 4!**
...
| `src/dataMigrator.py` | Main source code - **has bugs to fix** |
| `src/schemaMapper.py` | Supporting code - **may also have bugs** |
| `tests/test_dataMigrator.py` | Test file - **add your tests here** |
...
### Bug #1 - in `src/dataMigrator.py` (around line 15)
**What's wrong:** - see PR comments."""

**How to find it:** Open `src/dataMigrator.py` and look for the `BUG:` comment near line 15. Read the comment carefully - it describes exactly what's broken.
...
### Bug #2 - in `src/dataMigrator.py` (around line 19)
**What's wrong:** described in TICKET.md

**How to find it:** Open `src/dataMigrator.py` and look for the `BUG:` comment near line 19. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #3 - in `src/dataMigrator.py` (around line 24)
**What's wrong:** in logic."""

**How to find it:** Open `src/dataMigrator.py` and look for the `BUG:` comment near line 24. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #4 - in `src/schemaMapper.py` (around line 15)
**What's wrong:** - see PR comments."""

**How to find it:** Open `src/schemaMapper.py` and look for the `BUG:` comment near line 15. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #5 - in `src/schemaMapper.py` (around line 19)
**What's wrong:** described in TICKET.md

**How to find it:** Open `src/schemaMapper.py` and look for the `BUG:` comment near line 19. Read the comment carefully - it describes exactly what's broken.

**Hint:** Think about what the correct behavior should be (described in `TICKET.md` under Requirements), then compare it to what the code actually does.

### Bug #6 - in `src/schemaMapper.py` (around line 24)
**What's wrong:** in logic."""

**How to find it:** Open `src/schemaMapper.py` and look for the `BUG:` comment near line 24. Read the comment carefully - it describes exactly what's broken.
